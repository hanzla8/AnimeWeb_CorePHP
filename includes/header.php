<?php
    session_start();
    define("APPURL", "http://localhost:8686/anime-php");
    define("IMAGEURL", "http://localhost:8686/anime-php/admin-panel/shows-admins/img");
    define("VIDEOSURL", "http://localhost:8686/anime-php/admin-panel/episodes-admins/videos");
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <!-- 2nd -->
                                    <!-- Php Ka user name lane ka patter -->
                                    <?php if (isset($_SESSION['username'])) : ?>
                                    <li><a href="#"><?php echo $_SESSION['username'] ?> <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        <li><a href="<?php echo APPURL ;?>/users/following.php">Following</a></li>
                ...
                <div class="col-lg-2">
                    ...
                    <form action="<?php echo APPURL; ?>/search.php" method="POST" class="form-inline">
                        <input name="keyword" style="margin-left: -150px;" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                        <button name="submit" type="submit" style="background-color: white; color: #46392c; outline: none" class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
                    </form>                        
