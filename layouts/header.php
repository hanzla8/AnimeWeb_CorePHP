...
<body>
    <div id="wrapper">
        <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="#">HF Developer</a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <ul class="navbar-nav side-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ADMINURL; ?>/genres-admins/show-genres.php"
                                style="margin-left: 20px;">Genres</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ADMINURL; ?>/episodes-admins/show-episodes.php"
